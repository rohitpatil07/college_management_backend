...
router.get('/allsubjects', authenticate(["faculty","student"]),subjectController.getAllSubject);
...
router.get('/module/:moduleid',authenticate(["faculty","student"]),moduleController.getModulebyID);
router.get('/allmodules/:subid',authenticate(["faculty","student"]),moduleController.getModulebySubject);

router.get('/readmat/module/:moduleid',authenticate(["faculty","student"]),readingController.getReadMatByModuleId)
